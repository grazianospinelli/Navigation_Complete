...
import {
	ActivityIndicator, ListView, StyleSheet, Image, TouchableOpacity,
...
export default class ChatScreen extends Component {
	...
	var message = this.state.newMessage;
		if (message) {
			...
			messagesCopy[0] = {mesFromUUID: this.state.userUUID, mesToUUID: this.state.restUUID, mesText: message}
